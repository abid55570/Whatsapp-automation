...
export const CircularTestimonials = ({
  ...
  const colorArrowBg = colors.arrowBackground ?? "#25d366";
  const colorArrowFg = colors.arrowForeground ?? "#ffffff";
  const colorArrowHoverBg = colors.arrowHoverBackground ?? "#1faa59";
    ...
    <div className="testimonial-container">
      ...
      <style jsx>{`
        ...
        .testimonial-image {
          ...
          height: 100%;
          object-fit: contain;
          background: linear-gradient(160deg, #e9fbf2, #c8f5dd);
